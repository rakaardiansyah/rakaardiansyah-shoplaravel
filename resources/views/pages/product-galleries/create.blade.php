...
@section('content')
    <div class="card">
        ...
        <div class="card-body card-block">
            ...
            <!-- enctype="multipart/form-data" di gunakan untuk nambah gambar -->
                @csrf
                <!-- @ csrf untuk memastikan form yang kita gunakan bukan dari hacker -->
                ...
                {{--  http://127.0.0.1:8000/product-galleries/public/images/logo2.png --}}
