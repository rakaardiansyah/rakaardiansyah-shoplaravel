...
class TransactionController extends Controller
{
    ...
    {
        //$ items membawa data dari item transaksi
    ...
    {
        /**mengambil data di model Transaction > di hubungkan ke
        fungsi relasi (details) yg terhubung ke produk 
        TransactionDetail (transactions_id > product) **/
